...
Java_com_kgtts_kgtts_1app_audio_SpeexNative_nativeCreate(
    JNIEnv*,
    jclass,
    jint frameSize,
    jint sampleRate) {
...
Java_com_kgtts_kgtts_1app_audio_SpeexNative_nativeDestroy(JNIEnv*, jclass, jlong handlePtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_kgtts_kgtts_1app_audio_SpeexNative_nativeProcessFrame(
    JNIEnv* env,
    jclass,
    jlong handlePtr,
